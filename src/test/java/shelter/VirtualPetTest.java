...
public class VirtualPetTest {
    ...
    @Before
    public void setUp() {
        underTest = new VirtualPet("Rusty", "smells like a Stargazer lily fresh with morning dew", 10, 0, 0,5);
        foundPet = new VirtualPet("Rusty", "", 10, 0, 0,0);
    }

    @Test
    public void shouldFindName() {
        VirtualPet underTest = new VirtualPet("Rusty", "", 10, 0, 0,0);
    ...
    public void shouldFindDescription() {
        underTest = new VirtualPet("Rusty", "smells like a Stargazer lily fresh with morning dew", 10, 0, 0,0);
    ...
    public void shouldReturnValueOfThirst() {
        underTest = new VirtualPet("Rusty", "smells like a Stargazer lily fresh with morning dew", 0, 10, 0,0);
    ...
    public void shouldReturnValueOfBoredom() {
        underTest = new VirtualPet("Rusty", "smells like a Stargazer lily fresh with morning dew", 0, 0, 10,0);
    ...
    public void shouldReturnValueOfAttributes() {
        underTest = new VirtualPet("Rusty", "smells like a Stargazer lily fresh with morning dew", 10, 10, 10,0);
